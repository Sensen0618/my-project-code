...
for col1 = 1:4
    ...
    % Inner loop for positions in row 1
    for col2 = col1+1:4
        % Place 1 in row 1
        matrix(1, col2) = 1;
        
        % Outer loop for positions in row 2
        for col3 = 1:4
            % Place 1 in row 2
            matrix(2, col3) = 1;
            ...
            for col4 = col3+1:4
                ...
                % Outer loop for positions in row 3
                for col5 = 1:4
                    % Place 1 in row 3
                    matrix(3, col5) = 1;
                    ...
                    for col6 = col5+1:4
                        ...
                        % Outer loop for positions in row 4
                        for col7 = 1:4
                            % Place 1 in row 4
                            matrix(4, col7) = 1;
...
v_min = -120;
v_max = 120;           % velocity limit for power particles
...
gpbest = 100000 * ones(rad, tar, Psize/ssize);
gabest = 100000 * ones(rad, tar, Psize/ssize);
...
%                 end
    ...
    plot(record);
    title('Evolution of Optimal Fitness (k=2)')
    pause(0.0001) 
end
