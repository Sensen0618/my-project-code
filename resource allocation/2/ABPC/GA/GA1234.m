...
time = [401.756737, 1209.862061, 281.671530, 506.041486];

% Load data
load('case2_GA1_record.mat', 'record1');
load('case2_GA2_record.mat', 'record2');
load('case2_GA3_record.mat', 'record3');
load('case2_GA4_record.mat', 'record4');
...
% text(length(record4)*0.4, max(record4)*0.8, sprintf('Final Power: %.2e W', final_value4), ...
%     'FontSize', 16, 'BackgroundColor', 'white');
% text(length(record4)*0.4, max(record4)*0.65, sprintf('runtime: %.2f S', time(4)), ...
%     'FontSize', 16, 'BackgroundColor', 'white');
% 
% % Add overall title
...
% Save figure
print('case2_GA1234.jpg', '-dpng', '-r300');
fprintf('Figure saved as case2_GA1234.jpg\n');