...
angle_m=[0 14 37
       ...
       -37 0 14
       -37 -14 0];
Rat=[sqrt(2.8051) sqrt(2.9449) sqrt(4.2501) 
    sqrt(2.9542) sqrt(2.7886) sqrt(4.2572) 
    sqrt(4.2568) sqrt(2.7812) sqrt(2.9620) 
    sqrt(4.2513) sqrt(2.9628) sqrt(2.7859)]'; %ratio
s_m=size(angle_m,2);
...
%%%坐标
    ...
    text(angle_m(1,1)-12,DB11+4,[num2str(DB11)],'FontSize',10,'FontName','Times New Roman')

    DB12=bp1(angle_m(1,2)/0.5+181);
    DB12=roundn(DB12,-2); 
    plot(angle_m(1,2),DB12,'r*')
    text(angle_m(1,2)-7,DB12+4,[num2str(DB12)],'FontSize',10,'FontName','Times New Roman')

    DB13=bp1(angle_m(1,3)/0.5+181);
    DB13=roundn(DB13,-2); 
    plot(angle_m(1,3),DB13,'r*')
    text(angle_m(1,3)-2,DB13+4,[num2str(DB13)],'FontSize',10,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');  
    ...
    text(angle_m(2,2)-8,DB22+4,[num2str(DB22)],'FontSize',10,'FontName','Times New Roman')

    DB23=bp2(angle_m(2,3)/0.5+181);
    DB23=roundn(DB23,-2); 
    plot(angle_m(2,3),DB23,'r*')
    text(angle_m(2,3)-2,DB23+4,[num2str(DB23)],'FontSize',10,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');    
    ...
    text(angle_m(3,2)-11,DB32+4,[num2str(DB32)],'FontSize',10,'FontName','Times New Roman')

    DB33=bp3(angle_m(3,3)/0.5+181);
    DB33=roundn(DB33,-2); 
    plot(angle_m(3,3),DB33,'r*')
    text(angle_m(3,3)-6,DB33+4,[num2str(DB33)],'FontSize',10,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');   
    ...
    text(angle_m(4,2)-11,DB42+4,[num2str(DB42)],'FontSize',10,'FontName','Times New Roman')

    DB43=bp4(angle_m(4,3)/0.5+181);
    DB43=roundn(DB43,-2); 
    plot(angle_m(4,3),DB43,'r*')
    text(angle_m(4,3)-6,DB43+4,[num2str(DB43)],'FontSize',10,'FontName','Times New Roman')

xlabel({'\fontname{宋体}\fontsize{20}方位角 (°)','\fontname{Times New Roman}\fontsize{20}(d)'});
ylabel('\fontname{宋体}\fontsize{20} 波束图 (dB)');
set(gca, 'YLim', [-70,7],'FontSize',19,'FontName','Times New Roman');
 %   saveas(gcf,['4boshu3','.emf']);
