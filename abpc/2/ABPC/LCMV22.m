...
angle_m=[-26.5 8
        ...
        23 39
         0 26.5];
Rat=[sqrt(2901.3) sqrt(7098.7 ) 
    sqrt(3316.7 ) sqrt(6683.3) 
    sqrt(2227.7) sqrt(7772.3) 
    sqrt(2626.5) sqrt(7373.5)]'; %ratio
s_m=size(angle_m,2);
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');  
    ...
    text(angle_m(2,2)-2,DB22+4,[num2str(DB22)],'FontSize',10,'FontName','Times New Roman')

xlabel({'\fontname{宋体}\fontsize{20}方位角 (°)','\fontname{Times New Roman}\fontsize{20}(b)'});
ylabel('\fontname{宋体}\fontsize{20} 波束图 (dB)');
set(gca, 'YLim', [-50,7],'FontSize',19,'FontName','Times New Roman');
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');    
    ...
    text(angle_m(3,2)-2,DB32+4,[num2str(DB32)],'FontSize',10,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');   
    ...
    text(angle_m(4,1)-10,DB41+4,[num2str(DB41)],'FontSize',10,'FontName','Times New Roman')
