...
angle_m=[-26.5 8 37
        ...
        -45 23 39
        -16 0 26.5];
Rat=[sqrt(2032.1 ) sqrt(5304.2) sqrt(2663.7) 
    sqrt(1673.6) sqrt(3166.7) sqrt(5159.7) 
    sqrt(2729.5) sqrt(1624.5) sqrt(5646.0) 
    sqrt(4627.3) sqrt(1394.1) sqrt(3978.6)]'; %ratio
s_m=size(angle_m,2);
...
%%%坐标
    ...
    text(angle_m(1,1)-9,DB11+4,[num2str(DB11)],'FontSize',10,'FontName','Times New Roman')

    DB12=bp1(angle_m(1,2)/0.5+181);
    DB12=roundn(DB12,-2); 
    plot(angle_m(1,2),DB12,'r*')
    text(angle_m(1,2)-2,DB12+4,[num2str(DB12)],'FontSize',10,'FontName','Times New Roman')

    DB13=bp1(angle_m(1,3)/0.5+181);
    DB13=roundn(DB13,-2); 
    plot(angle_m(1,3),DB13,'r*')
    text(angle_m(1,3)-9,DB13+4,[num2str(DB13)],'FontSize',10,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');    
    ...
    text(angle_m(3,1)-10,DB31+4,[num2str(DB31)],'FontSize',10,'FontName','Times New Roman')

    DB32=bp3(angle_m(3,2)/0.5+181);
    DB32=roundn(DB32,-2); 
    plot(angle_m(3,2),DB32,'r*')
    text(angle_m(3,2)-9,DB32+4,[num2str(DB32)],'FontSize',10,'FontName','Times New Roman')

    DB33=bp3(angle_m(3,3)/0.5+181);
    DB33=roundn(DB33,-2); 
    plot(angle_m(3,3),DB33,'r*')
    text(angle_m(3,3)-2,DB33+4,[num2str(DB33)],'FontSize',10,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');   
    ...
    text(angle_m(4,2)-10,DB42+4,[num2str(DB42)],'FontSize',10,'FontName','Times New Roman')
