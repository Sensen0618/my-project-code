...
angle_m=[-26.5 8 37 45
        -56.5 0 45 51.5
         -45 -4.5 23 39
        -51.5 -16 0 26.5];
Rat=[sqrt(1) sqrt(1) sqrt(1) sqrt(1)
    sqrt(1) sqrt(1) sqrt(1) sqrt(1)
    sqrt(1) sqrt(1) sqrt(1) sqrt(1)
    sqrt(1) sqrt(1) sqrt(1) sqrt(1)]'; %ratio
s_m=size(angle_m,2);
...
%%%坐标
    ...
    text(angle_m(1,4),DB14+3,[num2str(DB14)],'FontSize',8,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');  
    ...
    text(angle_m(2,4),DB24+3,[num2str(DB24)],'FontSize',8,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');    
    ...
    text(angle_m(3,4)-5,DB34+3,[num2str(DB34)],'FontSize',8,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');   
    ...
    text(angle_m(4,4)-5,DB44+3,[num2str(DB44)],'FontSize',8,'FontName','Times New Roman')
