...
tar = 4;         %4个目标  
rad = 4;         %4部雷达
Psize = 5000;  %种群个数(k=1,3)
% Psize = 182000;  %种群个数(k=2)
MaxIt = 1200;    %迭代次数
sumA = 10000;    %每部雷达阵元数目
% c1 = 1.5;        %算法参数
% c2 = 1.5;        %算法参数
...
P = (10000*ones(rad,tar,Psize)+repmat(unidrnd(10000,rad,1,Psize),[1 tar])).*[0 1 0 0]';   %功率矩阵
% a = sum(P,2);
A = [2581.65 2527.14 2527.14 2581.65]'.*ones(4,4,Psize);       %由功率矩阵更新阵元矩阵
% v_min = -200;
% v_max = 200;           % 功率粒子的速度限制
v_min = -120;
v_max = 120; 
