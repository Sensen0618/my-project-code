...
angle_m=[0 14 
         ...
         0 14
          -14 0];
Rat=[sqrt(4.8388 ) sqrt(5.1612) 
    sqrt( 5.1616) sqrt(4.8384) 
    sqrt(4.836) sqrt(5.164) 
    sqrt(5.1640) sqrt( 4.8360)]'; %ratio
s_m=size(angle_m,2);
...
set(gca, 'YLim', [-80,7],'FontSize',19,'FontName','Times New Roman');
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');  
    ...
    text(angle_m(2,1)-2,DB21+4,[num2str(DB21)],'FontSize',10,'FontName','Times New Roman')

    DB22=bp2(angle_m(2,2)/0.5+181);
    DB22=roundn(DB22,-2); 
    plot(angle_m(2,2),DB22,'r*')
    text(angle_m(2,2)-5,DB22+4,[num2str(DB22)],'FontSize',10,'FontName','Times New Roman')
...
set(gca, 'xtick',angle(1, 1):delta: angle(1, 2),'FontSize',15,'FontName','Times New Roman');   
    ...
    text(angle_m(4,1)-3,DB41+4,[num2str(DB41)],'FontSize',10,'FontName','Times New Roman')

    DB42=bp4(angle_m(4,2)/0.5+181);
    DB42=roundn(DB42,-2); 
    plot(angle_m(4,2),DB42,'r*')
    text(angle_m(4,2)-8,DB42+4,[num2str(DB42)],'FontSize',10,'FontName','Times New Roman')

xlabel({'\fontname{宋体}\fontsize{20}方位角 (°)','\fontname{Times New Roman}\fontsize{20}(d)'});
ylabel('\fontname{宋体}\fontsize{20} 波束图 (dB)');
set(gca, 'YLim', [-80,7],'FontSize',19,'FontName','Times New Roman');

  %   saveas(gcf,['4boshu2','.emf']);
