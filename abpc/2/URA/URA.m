...
P = (200000000*ones(rad,tar,Psize)+repmat(unidrnd(200000000,rad,1,Psize),[1 tar])).*[0 1 1 1]';   %功率矩阵
% a = sum(P,2);
A = [2597.21 2482.81 2542.91 2539.21]'.*ones(4,4,Psize);       %由功率矩阵更新阵元矩阵
v_min = -2000;
v_max = 2000;           % 功率粒子的速度限制
...
SNR = (P.*A.*lamda.^2.*sigma)./(4^3*pi.^3*L*k*F*B*T.*R.^4.*10^12);   %信噪比
